...
import {renderItem} from '../../../elements/table-item';
...
export const TableOperacionesEquipo = ({
    ...
    headers: { key: string; label: string; width?: string; type?: string }[];
}) => {
    ...
    const request = () => {
        api(
            `/operaciones/?tipo_equipo=${parent.equipo?.tipo_equipo?.id}&limit=999999`,
            'GET'
        );
    };
    ...
    useEffect(() => {
        console.log("operaciones recalculadas :: ", recalcula(operaciones, operacionesEquipo));
